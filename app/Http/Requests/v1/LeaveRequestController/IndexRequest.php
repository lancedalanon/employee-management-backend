...
class IndexRequest extends FormRequest
{
   ...
   /**
    ...
    {
        return [
            'sort' => 'in:dtr_id,dtr_absence_date,dtr_absence_reason,dtr_absence_approved_at',
            'order' => 'in:asc,desc',
    ...
    {
        return [
            'sort.in' => 'Please choose a valid field to sort by (dtr_id, dtr_absence_date, dtr_absence_reason, dtr_absence_approved_at)',
