...
class IndexRequest extends FormRequest
{
    ...
    {
        return [
            'sort' => 'in:dtr_id,dtr_time_in,dtr_time_out,dtr_end_of_the_day_report,dtr_is_overtime',
            'order' => 'in:asc,desc',
    ...
    {
        return [
            'sort.in' => 'Please choose a valid field to sort by (dtr_id, dtr_time_in, dtr_time_out, dtr_end_of_the_day_report, dtr_is_overtime)',
    ...
    {
        $this->merge([
            'sort' => $this->input('sort', 'dtr_id'), // Default sort by 'dtr_id'
