...
class IndexTest extends TestCase
{
    ...
    public function testAuthenticatedUserCanRetrievePaginatedProjectTasksData(): void
    {
        // Act the response
        $response = $this->getJson(route('v1.projects.tasks.subtasks.index', [
    ...
    public function testAuthenticatedUserCanRetrieveEmptyPaginatedProjectTasksData(): void
    {
        // Arrange that the project task should be empty
        ProjectTaskSubtask::where('project_task_subtask_id', $this->projectTaskSubtask->project_task_subtask_id)->delete();
        ...
        // Assert specific data fragments
        $response->assertJsonFragment([
            'message' => 'No subtasks found for the provided criteria.',
        ]);
    }
}
