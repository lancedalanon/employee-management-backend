...
class AssignUserTest extends TestCase
{
    ...
    public function testAuthenticatedUserCanAssignUserToProjectTask(): void
    {
        // Arrange user
        ...
        // Act the response
        $response = $this->postJson(route('v1.projects.tasks.users.assignUser', [
    ...
    public function testAuthenticatedUserFailsToAssignUserToProjectTaskIfUserIsNotPartOfTheProject(): void
    {
        // Arrange user
        $user = User::factory()->withRoles(['employee', 'full_time', 'day_shift'])->create();
