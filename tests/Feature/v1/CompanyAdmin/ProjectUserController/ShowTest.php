...
class ShowTest extends TestCase
{
    ...
    public function testCompanyAdminCanRetrieveProjectUserById(): void
    {
        // Act the response
        $response = $this->getJson(route('v1.companyAdmin.projects.users.show', [
    ...
    public function testCompanyAdminFailsToRetrieveProjectUserByIdIfNotFound(): void
    {
        // Act the response
        $response = $this->getJson(route('v1.companyAdmin.projects.users.show', [
            'projectId' => $this->project->project_id,
